...
module.exports = {
    ...
    install(req, res) {
        ...
        console.log(
            '2. Redirect url to authenticate to Zoom:',
            redirectUrl,
            '\n'
        )
    ...
    /** zoom을 통해서 사용자 인증을 하고 앱에서 내 개인 정보를 사용해도 좋다는 인증을 해주면,
     * redirect handler가 시작된다.
     * */
    ...
    async auth(req, res, next) {
        ...
        try {
            ...
            console.log(
                '4. Redirecting to Zoom client via deeplink . . .',
                '\n'
            )
    ...
    home(req, res, next) {
        ...
        try {
            ...
            if (
                !decryptedAppContext.exp ||
                decryptedAppContext.exp < Date.now()
            ) {
                throw new Error('x-zoom-app-context header is expired')
            }

            console.log(
                '1. Decrypted Zoom App Context:',
                decryptedAppContext,
                '\n'
            )
            console.log(
        ...
        // 4. Redirect to frontend(사용자를 이동시킴)
